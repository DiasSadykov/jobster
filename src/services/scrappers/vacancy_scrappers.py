...
ALL_SCRAPPERS = [
                    HHKZVacancyScrapper("vacancies/programmist?", "hh.kz programmer", hour=22, minute=45),
                    HHKZVacancyScrapper("vacancies/dizajner-interfejsov?", "hh.kz designer", hour=22, minute=50),
                    HHKZVacancyScrapper("vacancies/sistemnyy_administrator?", "hh.kz sysadmin", hour=22, minute=55),
